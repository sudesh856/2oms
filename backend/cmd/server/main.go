...
func NewRouter(
	...
	r.Group(func(r chi.Router) {
		...
		r.With(auth.RequireRole("superadmin", "admin", "staff")).Patch("/api/orders/{id}", orderHandler.UpdateOrder)
		...
		r.With(auth.RequireRole("superadmin", "admin", "staff")).Get("/api/orders/{id}/followups", orderHandler.ListOrderFollowUps)
		...
		r.With(auth.RequireRole("superadmin", "admin", "staff")).Get("/api/couriers", courierHandler.ListCouriers)
		...
		r.With(auth.RequireRole("superadmin", "admin", "staff")).Get("/api/couriers/{courierID}/locations", courierHandler.ListLocations)
